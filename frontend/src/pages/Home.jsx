    ...
    <>
        ...
        <div className="hero-wrap">
          <div className="hero-left">
            ...
            <p className="hero-text">
              ...
              <b>NLP-based AI assessment</b>, risk evaluation, and nearby emergency
              services
            </p>
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <Link to={user ? "/ai-assistant" : "/login"} className="learn-more">
      ...
      <section className="cta-section">
        <div className="cta-container">
          ...
          <p>
            {user 
              ? "Start your AI assessment now or contact emergency services immediately if you're in a critical situation"
              : "Login to access AI assessment or contact emergency services immediately if you're in a critical situation"
            }
          </p>
          <div className="cta-buttons">
            {user ? (
              ...
              <Link to="/login" className="cta-btn cta-btn-red">
