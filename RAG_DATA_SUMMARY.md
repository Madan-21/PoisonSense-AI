...
- **Embedding Model:** Hugging Face Inference API (sentence-transformers/all-MiniLM-L6-v2, 384 dims — FREE)
...
### **Current Settings:**
```python
EMBEDDING_MODEL = "sentence-transformers/all-MiniLM-L6-v2"  # HF Inference API (free)
EMBEDDING_DIMENSIONS = 384       # all-MiniLM-L6-v2 output dims
LLM_PROVIDER = "groq"           # Llama 3.3 70B (free)
